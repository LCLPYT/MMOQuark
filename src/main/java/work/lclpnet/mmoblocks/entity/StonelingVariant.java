...
import static work.lclpnet.mmoblocks.module.NewStoneTypesModule.*;
...
public enum StonelingVariant implements EntityData {
	...
	StonelingVariant(String variantPath, Block... blocks) {
		this.texture = MMOBlocks.identifier(String.format("textures/model/entity/stoneling/%s.png", variantPath));
