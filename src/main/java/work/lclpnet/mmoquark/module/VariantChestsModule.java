...
public class VariantChestsModule implements IModule {
    ...
    public void register() {
        addChests(this::addChest, Blocks.CHEST);
        addChests(this::addTrappedChest, Blocks.TRAPPED_CHEST);
    ...
    private void addChests(BiConsumer<String, Block> chestRegistrar, Block parent) {
        Consumer<String> baseChestConsumer = type -> chestRegistrar.accept(type, parent);
    ...
    private void addTrappedChest(String blockType, Block parent) {
        VariantTrappedChestBlock variantTrappedChest = new VariantTrappedChestBlock(AbstractBlock.Settings.copy(parent), () -> VARIANT_TRAPPED_CHEST_ENTITY);
